...
const CAROUSEL_CARDS = [
  { label: "Casual",    rotate: -8, yOffset: 56, img: "/outfit-casual.jpg",   alt: "Casual outfit idea generated by Slidez AI stylist app" },
  { label: "Work",      rotate: -4, yOffset: 28, img: "/outfit-work.jpg",     alt: "AI fashion stylist work outfit suggestion with virtual try-on" },
  { label: "Night Out", rotate: 0,  yOffset: 0,  img: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=600&q=85&fit=crop&crop=top", alt: "Night out outfit generated by AI stylist outfit generator Slidez" },
  { label: "Weekend",   rotate: 4,  yOffset: 28, img: "/outfit-weekend.jpg",  alt: "Weekend look from Slidez AI virtual try-on clothing preview" },
  { label: "Vacation",  rotate: 8,  yOffset: 56, img: "/outfit-vacation.jpg", alt: "Vacation outfit idea previewed with Slidez AI virtual try-on" },
];
  ...
  const handleStylerComplete = useCallback(
    async (payload: FloatingStylerOnCompletePayload) => {
      ...
      if (payload.avatar === "upload" && payload.uploadedFile) {
        ...
        setSelectedModelSrc(payload.avatar === "model-man" ? "/model-man.jpg" : "/model-woman.jpg");
      }
