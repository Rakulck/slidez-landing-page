...
const CHIPS = ["Date Night", "Office", "Party", "Casual", "Winter", "Beach"];

const PROMPTS = [
  "Style me for a rooftop dinner date",
  "What should I wear to a job interview?",
  "Create a weekend brunch outfit",
  "Put together a concert look",
];
...
export default function AiStylistTemplate() {
