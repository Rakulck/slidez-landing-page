...
const GENERATED_EXAMPLES = [
  {
    ...
    sub: "Wide-leg white trousers · Minimal accessories",
    prompt: "Minimal casual outfit",
    img: "/outfit-casual.jpg",
    alt: "Minimal casual outfit generated by Slidez AI stylist",
  },
  {
    label: "Blue button-down shirt",
    sub: "High-waist white wide-leg pants · Black tote",
    prompt: "NYC street style outfit",
    img: "/outfit-nyc.jpg",
    alt: "NYC street style outfit generated by Slidez AI",
  },
  {
    label: "Navy blazer suit",
    sub: "White cami · Tailored trousers · Black bag",
    prompt: "Smart work outfit",
    img: "/outfit-work.jpg",
    alt: "Smart work outfit from Slidez AI Stylist",
  },
  {
    label: "Ivory knit cardigan",
    sub: "Cream wide-leg trousers · Gold layered necklace",
    prompt: "Effortless weekend outfit",
    img: "/outfit-weekend.jpg",
    alt: "Effortless weekend outfit — cosy knit and trousers",
  },
];
