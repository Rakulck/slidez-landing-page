...
const GENERATED_EXAMPLES = [
  {
    label: "Black one-shoulder jumpsuit",
    sub: "Silver mini bag · Metallic heels · Minimal jewellery",
    prompt: "Elegant date night outfit",
    img: "/inspiration/date-night.jpg",
    alt: "Elegant date night outfit generated by Slidez AI stylist",
  },
  {
    label: "Sequin crop top",
    sub: "Wide-leg light-wash jeans · Black bag · Pointed heels",
    prompt: "Bold party night out outfit",
    img: "/inspiration/party.jpg",
    alt: "Party night out outfit generated by Slidez AI",
  },
  {
    label: "Teal linen shirt",
    sub: "Cream wide-leg trousers · Sunglasses · Bracelets",
    prompt: "Relaxed summer casual outfit for men",
    img: "/inspiration/casual-men.jpg",
    alt: "Summer casual outfit for men from Slidez AI Stylist",
  },
  {
    label: "Cream ruched beach dress",
    sub: "Pearl necklace · Bare feet · Beachy waves",
    prompt: "Vacation beach outfit",
    img: "/inspiration/beach.jpg",
    alt: "Vacation beach outfit generated by Slidez AI",
  },
];
