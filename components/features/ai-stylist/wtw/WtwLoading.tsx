      ...
      <div className="relative w-full h-full min-h-[480px] md:min-h-[520px] flex flex-col px-4 overflow-hidden bg-white rounded-2xl">
        ...
        >
          <AnimatePresence mode="sync">
            {eyebrow && (
              <AnimatedPhrase key={eyebrow.id} className="w-full">
                <p
          ...
          <div className="w-full min-h-[120px] md:min-h-[140px] flex flex-col items-center justify-center">
            <AnimatePresence mode="sync">
              {numberLayer && (
                <AnimatedPhrase key={`num-${numberLayer.label}`} className="w-full">
              ...
              {showAlmostOnly && almostDone && (
                <AnimatedPhrase key={almostDone.id} className="w-full">
                  <h2
              ...
              {showMega && mega && (
                <AnimatedPhrase key={mega.id} className="w-full">
                  <motion.h2
              ...
              {!numberLayer && !showAlmostOnly && !showMega && hero && (
                <AnimatedPhrase key={hero.id} className="w-full">
                  <h2
              ...
              {showClosingLine && closing && (
                <AnimatedPhrase key={closing.id} className="w-full mt-3">
                  <p
            ...
            <AnimatePresence mode="sync">
              {showHeroWithSub && sub && (
                <AnimatedPhrase key={`${sub.id}-below`} className="w-full mt-4">
                  <p
