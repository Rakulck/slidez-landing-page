...
export const WTW_PICKER_MODELS: Record<Gender, WtwPickerModel[]> = {
  Women: [
    { id: "model-brown-w", src: "/models/model-brown-w.png", name: "Ava" },
    { id: "model-white-w", src: "/models/model-white-w.png", name: "Mia" },
  ],
  Men: [
    { id: "model-white", src: "/models/model-white.png", name: "Leo" },
    { id: "model-black", src: "/models/model-black.png", name: "Max" },
  ],
};

export const DEFAULT_WTW_MAN_SRC = "/models/model-white.png";
export const DEFAULT_WTW_WOMAN_SRC = "/models/model-brown-w.png";
...
export const PRESET_MODELS: PresetModel[] = [
  ...
  { id: "blonde-woman",       src: "/models/model-white-w.png",      label: "Blonde Woman",   gender: "Women" },
  { id: "brunette-woman",     src: "/models/model-brown-w.png",      label: "Brunette Woman", gender: "Women" },
  ...
  { id: "black-man",          src: "/models/model-black.png",        label: "Black Man",      gender: "Men"   },
  { id: "blonde-white-man",   src: "/models/model-white.png",        label: "Blonde Man",     gender: "Men"   },
  { id: "brunette-white-man", src: "/models/model-white.png",        label: "Brunette Man",   gender: "Men"   },
