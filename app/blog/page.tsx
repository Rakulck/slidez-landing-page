      ...
      <section data-nav-theme="light-bg" className="relative z-20 -mt-10 bg-[#fafafa] rounded-t-[2.5rem] px-6 py-16 md:py-24 shadow-sm border-t border-black/5">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link href="/blog/fashion-aesthetics-explained" className="group flex flex-col bg-white rounded-3xl border border-black/5 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
              <div className="relative w-full aspect-4/3 bg-[#f5f5f5] overflow-hidden">
                <Image 
                  ...
                  alt="Fashion Aesthetics Explained: Find Your Style preview image" 
                  fill
            ...
            {/* Blog Post Card - What Is Personal Style? A Beginner's Guide */}
            <Link href="/blog/what-is-personal-style" className="group flex flex-col bg-white rounded-3xl border border-black/5 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
              <div className="relative w-full aspect-4/3 bg-[#f5f5f5] overflow-hidden">
                <Image 
                  src="/what-is-personal-style.jpg" 
                  alt="What Is Personal Style? A Beginner's Guide preview image" 
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  className="object-cover group-hover:scale-105 transition-transform duration-500"
                />
            ...
            {/* Blog Post Card - How to Read a Clothing Size Chart Before Buying Online */}
            <Link href="/blog/how-to-read-a-clothing-size-chart" className="group flex flex-col bg-white rounded-3xl border border-black/5 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
              <div className="relative w-full aspect-4/3 bg-[#f5f5f5] overflow-hidden">
                <Image 
                  src="/how-to-read-a-clothing-size-chart.jpg" 
                  alt="How to Read a Clothing Size Chart Before Buying Online preview image" 
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  className="object-cover group-hover:scale-105 transition-transform duration-500"
                />
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <p className="text-black/60 text-sm leading-relaxed mb-6 flex-1">
                  Learn how to read a clothing size chart before buying online. How to measure yourself, match measurements to sizing, and avoid common fit mistakes.
                </p>
                <div className="flex items-center gap-2 text-sm font-bold text-black group-hover:gap-3 transition-all">
                  Read Article
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* Blog Post Card - How to Style New Clothes Before You Buy Them Online */}
            <Link href="/blog/style-new-clothes-before-you-buy-online" className="group flex flex-col bg-white rounded-3xl border border-black/5 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
              <div className="relative w-full aspect-4/3 bg-[#f5f5f5] overflow-hidden">
                <Image 
                  src="/style-new-clothes-before-you-buy-online.jpg" 
                  alt="How to Style New Clothes Before You Buy Them Online preview image" 
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  className="object-cover group-hover:scale-105 transition-transform duration-500"
                />
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <p className="text-black/60 text-sm leading-relaxed mb-6 flex-1">
                  Learn how to style new clothes before buying online. Avoid common mistakes and use virtual try-on and AI to choose pieces you&apos;ll actually wear.
                </p>
                <div className="flex items-center gap-2 text-sm font-bold text-black group-hover:gap-3 transition-all">
                  Read Article
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* Blog Post Card - How to Choose Clothes That Match Your Skin Tone */}
            <Link href="/blog/clothes-that-match-your-skin-tone" className="group flex flex-col bg-white rounded-3xl border border-black/5 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
              <div className="relative w-full aspect-4/3 bg-[#f5f5f5] overflow-hidden">
                <Image 
                  src="/clothes-that-match-your-skin-tone.jpg" 
                  alt="How to Choose Clothes That Match Your Skin Tone preview image" 
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  className="object-cover group-hover:scale-105 transition-transform duration-500"
                />
            ...
            {/* Blog Post Card - How to Match Clothes Like a Professional Stylist */}
            <Link href="/blog/how-to-match-clothes-like-a-stylist" className="group flex flex-col bg-white rounded-3xl border border-black/5 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
              <div className="relative w-full aspect-4/3 bg-[#f5f5f5] overflow-hidden">
                <Image 
                  src="/how-to-match-clothes-like-a-stylist.jpg" 
                  alt="How to Match Clothes Like a Professional Stylist preview image" 
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  className="object-cover group-hover:scale-105 transition-transform duration-500"
                />
            ...
            {/* Blog Post Card - How to Dress Better Without Chasing Every Trend */}
            <Link href="/blog/how-to-dress-better-without-trends" className="group flex flex-col bg-white rounded-3xl border border-black/5 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
              <div className="relative w-full aspect-4/3 bg-[#f5f5f5] overflow-hidden">
                <Image 
                  src="/how-to-dress-better-without-trends.jpg" 
                  alt="How to Dress Better Without Chasing Every Trend preview image" 
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  className="object-cover group-hover:scale-105 transition-transform duration-500"
                />
