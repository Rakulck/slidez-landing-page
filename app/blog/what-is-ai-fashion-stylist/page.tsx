        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16">
          ...
          <article className="flex-1 max-w-3xl text-black/75 text-lg leading-[1.85]">
            ...
            <div id="how-it-works" className="mb-16 scroll-mt-32">
              ...
              <p className="mb-6"><em>For a full guide on matching body shape, color, and fit algorithms, read <Link href="/blog/how-ai-helps-find-clothes-that-suit-you" className="text-black underline decoration-black/20 hover:decoration-black transition-all">how AI helps you find clothes that suit you</Link> or our technical breakdown of <Link href="/blog/algorithmic-fashion-recommendation-systems" className="text-black underline decoration-black/20 hover:decoration-black transition-all">algorithmic fashion recommendation systems</Link>.</em></p>
            </div>
