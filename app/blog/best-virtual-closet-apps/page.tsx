            ...
            <div id="best-apps" className="mb-16 scroll-mt-32">
              ...
              <div id="app-slidez" className="pt-10 mb-16 scroll-mt-32 border-t border-black/5">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 my-10 max-w-[800px] mx-auto">
                  <Image src="/blog-slidez-left.jpeg" alt="Slidez AI virtual closet app interface" width={400} height={800} className="w-full max-w-[320px] h-auto rounded-2xl border border-black/10 shadow-sm object-cover" />
                  <Image src="/blog-slidez-right.jpeg" alt="Slidez AI virtual closet app virtual try-on" width={400} height={800} className="w-full max-w-[320px] h-auto rounded-2xl border border-black/10 shadow-sm object-cover" />
                </div>
